...
exports.SpeculativeNonceTxMiddleware = void 0;
...
var log = (0, debug_1.default)('speculative-nonce-tx-middleware');
/**
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        this._lastNonce++;
                        log("Next nonce ".concat(this._lastNonce));
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        log("Fetched nonce ".concat(this._lastNonce));
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _b.sent();
