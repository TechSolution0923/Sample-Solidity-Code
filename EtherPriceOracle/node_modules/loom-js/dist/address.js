...
exports.Address = exports.LocalAddress = void 0;
...
var LocalAddress = /** @class */ (function () {
    ...
    LocalAddress.prototype.toChecksumString = function () {
        return (0, ethereumjs_util_1.toChecksumAddress)(this.toString());
    };
    ...
    LocalAddress.fromHexString = function (hexAddr) {
        ...
        if (bytes.length !== 20) {
            throw new Error("Invalid local address, expected 20 bytes, got ".concat(bytes.length));
        }
    ...
    LocalAddress.fromPublicKey = function (publicKey) {
        if (publicKey.length !== 32) {
            throw new Error("Invalid public key, expected 32 bytes, go ".concat(publicKey.length));
        }
...
var Address = /** @class */ (function () {
    ...
    Address.prototype.toString = function () {
        return "".concat(this.chainId, ":").concat(this.local.toString());
    };
    Address.prototype.MarshalPB = function () {
        var addr = new pb.Address();
        addr.setChainId(this.chainId);
        addr.setLocal((0, crypto_utils_1.bufferToProtobufBytes)(this.local.bytes));
        return addr;
    };
