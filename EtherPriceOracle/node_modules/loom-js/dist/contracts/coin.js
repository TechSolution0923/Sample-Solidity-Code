...
var Coin = /** @class */ (function (_super) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, (0, big_uint_1.unmarshalBigUIntPB)(result.getTotalSupply())];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, (0, big_uint_1.unmarshalBigUIntPB)(result.getBalance())];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, (0, big_uint_1.unmarshalBigUIntPB)(result.getAmount())];
                }
            });
        });
    };
    Coin.prototype.approveAsync = function (spender, amount) {
        ...
        approveReq.setAmount((0, big_uint_1.marshalBigUIntPB)(amount));
    ...
    Coin.prototype.transferAsync = function (to, amount) {
        ...
        transferReq.setAmount((0, big_uint_1.marshalBigUIntPB)(amount));
    ...
    Coin.prototype.transferFromAsync = function (from, to, amount) {
        ...
        transferFromReq.setAmount((0, big_uint_1.marshalBigUIntPB)(amount));
