...
var DPOS3 = /** @class */ (function (_super) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.getCandidatesList().map(function (candidate) {
                                var c = candidate.getCandidate();
                                // statistic may not exist yet for a candidate that was just registered (without being whitelisted)
                                var s = candidate.getStatistic();
                                return {
                                    address: address_1.Address.UnmarshalPB(c.getAddress()),
                                    pubKey: c.getPubKey_asU8(),
                                    delegationTotal: s && s.getDelegationTotal() ? (0, big_uint_1.unmarshalBigUIntPB)(s.getDelegationTotal()) : new bn_js_1.default(0),
                                    slashPercentage: s && s.getSlashPercentage() ? (0, big_uint_1.unmarshalBigUIntPB)(s.getSlashPercentage()) : new bn_js_1.default(0),
                                    whitelistAmount: s && s.getWhitelistAmount() ? (0, big_uint_1.unmarshalBigUIntPB)(s.getWhitelistAmount()) : new bn_js_1.default(0),
                                    whitelistLocktimeTier: s ? s.getLocktimeTier() : dposv3_pb_1.LocktimeTier.TIER_ZERO,
                                    maxReferralPercentage: c.getMaxReferralPercentage(),
                                    fee: new bn_js_1.default(c.getFee()),
                                    newFee: new bn_js_1.default(c.getNewFee()),
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, result.getStatisticsList().map(function (validator) { return ({
                                ...
                                whitelistAmount: validator.getWhitelistAmount()
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(validator.getWhitelistAmount())
                                    : new bn_js_1.default(0),
                                whitelistLocktimeTier: validator.getLocktimeTier(),
                                slashPercentage: validator.getSlashPercentage()
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(validator.getSlashPercentage())
                                    : new bn_js_1.default(0),
                                delegationTotal: validator.getDelegationTotal()
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(validator.getDelegationTotal())
                                    : new bn_js_1.default(0),
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                delegationTotal: result.getDelegationTotal()
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(result.getDelegationTotal())
                                    : new bn_js_1.default(0),
                        ...
                        return [2 /*return*/, result.getListResponsesList().map(function (d) {
                                return {
                                    delegationTotal: d.getDelegationTotal()
                                        ? (0, big_uint_1.unmarshalBigUIntPB)(d.getDelegationTotal())
                                        : new bn_js_1.default(0),
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
                                amount: result.getAmount() ? (0, big_uint_1.unmarshalBigUIntPB)(result.getAmount()) : new bn_js_1.default(0),
                                weightedAmount: result.getWeightedAmount()
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(result.getWeightedAmount())
                                    : new bn_js_1.default(0),
                                delegationsArray: result.getDelegationsList().map(this.getDelegation)
                            }];
                }
    ...
    DPOS3.prototype.delegateAsync = function (validator, amount, tier, referrer) {
        ...
        delegateRequest.setAmount((0, big_uint_1.marshalBigUIntPB)(amount));
    ...
    DPOS3.prototype.redelegateAsync = function (oldValidator, validator, amount, index, referrer) {
        ...
        redelegateRequest.setAmount((0, big_uint_1.marshalBigUIntPB)(amount));
    ...
    DPOS3.prototype.unbondAsync = function (validator, amount, index) {
        ...
        unbondRequest.setAmount((0, big_uint_1.marshalBigUIntPB)(new bn_js_1.default(amount)));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, resp.getAmount() ? (0, big_uint_1.unmarshalBigUIntPB)(resp.getAmount()) : new bn_js_1.default(0)];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.getAmount() ? (0, big_uint_1.unmarshalBigUIntPB)(result.getAmount()) : new bn_js_1.default(0)];
                }
            });
        });
    };
    DPOS3.prototype.getStateAsync = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, res, state, params, maxYearlyRewards, totalWeightedAmountStaked, minCandidateFee;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        maxYearlyRewards = (0, big_uint_1.unmarshalBigUIntPB)(params.getMaxYearlyReward());
                        totalWeightedAmountStaked = (0, big_uint_1.unmarshalBigUIntPB)(state.getTotalValidatorDelegations());
                        minCandidateFee = params.getMinCandidateFee();
                        return [2 /*return*/, {
    ...
    DPOS3.prototype.getDelegation = function (delegation) {
        return {
            ...
            amount: delegation.getAmount() ? (0, big_uint_1.unmarshalBigUIntPB)(delegation.getAmount()) : new bn_js_1.default(0),
            updateAmount: delegation.getUpdateAmount()
                ? (0, big_uint_1.unmarshalBigUIntPB)(delegation.getUpdateAmount())
                : new bn_js_1.default(0),
    ...
    DPOS3.prototype.updateCandidateInfoAsync = function (name, description, website, maxReferralPercentage) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var updateCandidateInfo;
            return tslib_1.__generator(this, function (_a) {
                updateCandidateInfo = new dposv3_pb_1.UpdateCandidateInfoRequestV3();
                ...
                return [2 /*return*/, this.callAsync('UpdateCandidateInfo', updateCandidateInfo)];
            });
        });
    };
    DPOS3.prototype.changeFeeAsync = function (fee) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var changeFee;
            return tslib_1.__generator(this, function (_a) {
                changeFee = new dposv3_pb_1.ChangeCandidateFeeRequestV3();
                changeFee.setFee(fee);
                return [2 /*return*/, this.callAsync('ChangeFee', changeFee)];
            });
        });
    };
    DPOS3.prototype.getDowntimeRecordAsync = function (validator) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, res;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new dposv3_pb_1.DowntimeRecordRequest();
                        req.setValidator(validator.MarshalPB());
                        return [4 /*yield*/, this.staticCallAsync('DowntimeRecord', req, new dposv3_pb_1.DowntimeRecordResponse())];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.getDowntimeRecordsList()];
                }
            });
        });
    };
    DPOS3.prototype.unjailAsync = function (validator) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new dposv3_pb_1.UnjailRequest();
                        if (validator) {
                            req.setValidator(validator.MarshalPB());
                        }
                        return [4 /*yield*/, this.callAsync('Unjail', req)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
