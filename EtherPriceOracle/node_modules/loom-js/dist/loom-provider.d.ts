...
export type SetupMiddlewareFunction = (client: Client, privateKey: Uint8Array) => ITxMiddlewareHandler[];
 ...
 */
export declare class LoomProvider implements AbstractProvider {
    private _client;
    private _subscribed;
