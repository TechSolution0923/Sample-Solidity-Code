...
exports.Client = exports.TxSyncBroadcaster = exports.TxCommitBroadcaster = exports.isTxAlreadyInCacheError = exports.TX_ALREADY_EXISTS_ERROR = exports.ClientEvent = void 0;
...
var debugLog = (0, debug_1.default)('client');
var ClientEvent;
...
var TxCommitBroadcaster = /** @class */ (function () {
    ...
    TxCommitBroadcaster.prototype.broadcast = function (client, txBytes) {
        return client.sendAsync('broadcast_tx_commit', [
            (0, crypto_utils_1.Uint8ArrayToB64)(txBytes)
        ]);
    };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, helpers_1.sleep)(this.resultPollingStrategy.minTimeout)];
                    case 2:
                        _a.sent();
                        op = retry_1.default.operation(this.resultPollingStrategy);
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                op.attempt(function (currentAttempt) {
                                    debugLog("Querying for result of tx ".concat(checkTxResult.hash, " - attempt ").concat(currentAttempt));
                                    client
                                        .sendAsync('tx', {
                                        ...
                                        .catch(function (err) {
                                        debugLog("Failed to retrieve result of tx ".concat(checkTxResult.hash, ": ").concat(err.message || err.data));
...
var Client = /** @class */ (function (_super) {
    ...
    function Client(chainId, writeClient, readClient) {
        ...
        _this.isWeb3EndpointEnabled = true === /eth$/.test(_this._readClient.url);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        throw err_1;
                    case 7:
                        debugLog("Result ".concat(JSON.stringify(result, null, 2)));
                        if (result) {
                            ...
                            if ((result.check_tx.code || 0) != 0) {
                                if (!result.check_tx.log) {
                                    throw new Error("Failed to commit Tx: ".concat(result.check_tx.code));
                                }
                                throw new Error("Failed to commit Tx: ".concat(result.check_tx.log));
                            }
                            if ((result.deliver_tx.code || 0) != 0) {
                                if (!result.deliver_tx.log) {
                                    throw new Error("Failed to commit Tx: ".concat(result.deliver_tx.code));
                                }
                                throw new Error("Failed to commit Tx: ".concat(result.deliver_tx.log));
                            }
                            if (result.deliver_tx.data) {
                                return [2 /*return*/, (0, crypto_utils_1.B64ToUint8Array)(result.deliver_tx.data)];
                            }
                        }
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._readClient.sendAsync('query', {
                            ...
                            query: query ? (0, crypto_utils_1.Uint8ArrayToB64)(query) : undefined,
                            vmType: vmType,
                    ...
                    case 1:
                        result = _a.sent();
                        if (result) {
                            return [2 /*return*/, (0, crypto_utils_1.B64ToUint8Array)(result)];
                        }
                        return [2 /*return*/];
                }
            });
     ...
     */
    Client.prototype.sendWeb3MsgAsync = function (method, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this._readClient.sendAsync(method, params)];
            });
        });
    };
    /**
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._readClient.sendAsync('evmtxreceipt', {
                            txHash: (0, crypto_utils_1.Uint8ArrayToB64)(txHash)
                        })];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            return [2 /*return*/, evm_pb_1.EvmTxReceipt.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)((0, crypto_utils_1.B64ToUint8Array)(result)))];
                        }
                        else {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result) {
                            return [2 /*return*/, evm_pb_1.EvmTxObject.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)((0, crypto_utils_1.B64ToUint8Array)(result)))];
                        }
                        else {
                            return [2 /*return*/, null];
                        }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        debugLog("Send filter ".concat(filter, " to getlogs"));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = JSON.stringify(filterObject);
                        debugLog("Send filter ".concat(filter, " to newfilter"));
    ...
    Client.prototype.getEvmFilterChangesAsync = function (id) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debugLog("Get filter changes for ".concat(JSON.stringify({ id: id }, null, 2)));
                    ...
                    case 1:
                        result = _a.sent();
                        if (result) {
                            envelope = evm_pb_1.EthFilterEnvelope.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(result));
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result) {
                            return [2 /*return*/, evm_pb_1.EthBlockInfo.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)((0, crypto_utils_1.B64ToUint8Array)(result)))];
                        }
                        else {
                            return [2 /*return*/, null];
                        }
     ...
     */
    Client.prototype.evmSubscribeAsync = function (method, params) {
        if (this.isWeb3EndpointEnabled) {
            return this._readClient.sendAsync('eth_subscribe', params);
        }
    ...
    Client.prototype.evmUnsubscribeAsync = function (id) {
        if (this.isWeb3EndpointEnabled) {
            return this._readClient.sendAsync('eth_unsubscribe', [id]);
        }
        return this._readClient.sendAsync('evmunsubscribe', { id: id });
    };
    /**
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        debugLog("Found contract ".concat(contractName, " with address ").concat(address_1.Address.fromString(addrStr)));
    ...
    Client.prototype._emitContractEvent = function (url, event, isEVM) {
        ...
        if (error) {
            ...
            var eventArgs = {
                ...
                url: url,
                contractAddress: new address_1.Address(result.address.chain_id, new address_1.LocalAddress((0, crypto_utils_1.B64ToUint8Array)(result.address.local))),
                callerAddress: new address_1.Address(result.caller.chain_id, new address_1.LocalAddress((0, crypto_utils_1.B64ToUint8Array)(result.caller.local))),
                blockHeight: result.block_height,
                data: (0, crypto_utils_1.B64ToUint8Array)(result.encoded_body || '0x0'),
                topics: result.topics,
                transactionHash: result.tx_hash,
                transactionHashBytes: result.tx_hash ? (0, crypto_utils_1.B64ToUint8Array)(result.tx_hash) : new Uint8Array([])
            };
            if (isEVM) {
