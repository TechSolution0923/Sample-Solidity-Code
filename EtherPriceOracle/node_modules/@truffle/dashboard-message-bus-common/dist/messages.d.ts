...
export declare type CliEventMessageType = "cli-event";
...
export declare type DashboardProviderMessageType = "provider";
...
export declare type LogMessageType = "log";
...
export declare type DebugMessageType = "debug";
...
export declare type InvalidateMessageType = "invalidate";
...
export declare type MessageType = CliEventMessage<unknown> | DashboardProviderMessageType | LogMessageType | DebugMessageType | InvalidateMessageType;
