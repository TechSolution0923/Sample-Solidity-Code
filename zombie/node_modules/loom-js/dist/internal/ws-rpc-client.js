...
var WSRPCClient = /** @class */ (function (_super) {
    ...
    function WSRPCClient(url, opts) {
        ...
        _this._rpcId = 0;
        _this._getNextRequestId = function () {
            var id = ++_this._rpcId;
            return _this.isWeb3EndpointEnabled ? id.toString() : id;
        };
        ...
        _this.isWeb3EndpointEnabled = true === /eth$/.test(url);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        log("Sending RPC msg to ".concat(this.url, ", method ").concat(method));
