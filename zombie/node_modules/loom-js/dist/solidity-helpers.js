...
exports.OfflineWeb3Signer = exports.Web3Signer = exports.EthersSigner = exports.getJsonRPCSignerAsync = exports.getMetamaskSigner = exports.soliditySha3 = void 0;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (v === 0 || v === 1) {
                            ...
                            mode = 0 /* SIGNATURE_TYPE.EIP712 */; // indicate that msg wasn't prefixed before signing (MetaMask doesn't prefix!)
                        }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Buffer.concat([
                                ethereumjs_util_1.default.toBuffer(1 /* SIGNATURE_TYPE.GETH */),
                                r,
                                s,
