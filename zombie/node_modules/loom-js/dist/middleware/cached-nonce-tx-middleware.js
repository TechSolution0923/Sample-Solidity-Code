...
exports.CachedNonceTxMiddleware = void 0;
...
var log = (0, debug_1.default)('cached-nonce-tx-middleware');
/**
...
var CachedNonceTxMiddleware = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        key = this._publicKey ? (0, crypto_utils_1.bytesToHex)(this._publicKey) : undefined;
                    ...
                    case 4:
                        log("Next nonce ".concat(this._lastNonce + 1));
    ...
    CachedNonceTxMiddleware.prototype.HandleResults = function (results) {
        ...
        if (isInvalidTx || isFailedTx) {
            ...
            this._lastNonce++;
            log("Incremented cached nonce to ".concat(this._lastNonce));
        }
        return results;
    };
    CachedNonceTxMiddleware.prototype.handleError = function (err) {
        if ((0, client_1.isTxAlreadyInCacheError)(err)) {
