...
var log = (0, debug_1.default)('loom-provider');
var error = (0, debug_1.default)('loom-provider:error');
var bytesToHexAddrLC = function (bytes) {
    return (0, crypto_utils_1.bytesToHexAddr)(bytes).toLowerCase();
};
var numberToHexLC = function (num) {
    return (0, crypto_utils_1.numberToHex)(num).toLowerCase();
};
/**
...
var LoomProvider = /** @class */ (function () {
    ...
    function LoomProvider(client, privateKey, setupMiddlewaresFunction) {
        ...
        if (!this._setupMiddlewares) {
            this._setupMiddlewares = function (client, privateKey) {
                return (0, helpers_1.createDefaultTxMiddleware)(client, privateKey);
            };
        }
    ...
    LoomProvider.prototype.addAccounts = function (accountsPrivateKey) {
        ...
        accountsPrivateKey.forEach(function (accountPrivateKey) {
            var publicKey = (0, crypto_utils_1.publicKeyFromPrivateKey)(accountPrivateKey);
            ...
            log("New account added ".concat(accountAddress));
        });
    };
    /**
    ...
    LoomProvider.chainIdToNetVersion = function (chainId) {
        ...
        var chainIdHash = (0, solidity_helpers_1.soliditySha3)(chainId)
            .slice(2) // Removes 0x
    ...
    LoomProvider.prototype.sendAsync = function (payload, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                if (callback) {
                    return [2 /*return*/, this.send(payload, callback)];
                }
                else {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        prepareMethodToCall = function (method) {
                            ...
                            if (!methodToCall) {
                                throw Error("Method \"".concat(payload.method, "\" not supported on this provider"));
                            }
                            return methodToCall;
                        };
                        _a.label = 1;
    ...
    LoomProvider.prototype._ethGetBlockByNumber = function (payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        blockNumberToSearch = payload.params[0] === 'latest' ? payload.params[0] : (0, crypto_utils_1.hexToNumber)(payload.params[0]);
                        isFull = payload.params[1] || true;
                        return [4 /*yield*/, this._client.getEvmBlockByNumberAsync("".concat(blockNumberToSearch), isFull)];
                    case 1:
                        result = _a.sent();
                        if (!result) {
                            return [2 /*return*/, null];
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                op.attempt(function (currentAttempt) {
                                    log("Current attempt ".concat(currentAttempt));
                                    _this._client
                                        .getEvmTxReceiptAsync((0, crypto_utils_1.bufferToProtobufBytes)(data))
    ...
    LoomProvider.prototype._ethSign = function (payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                hash = (0, solidity_helpers_1.soliditySha3)('\x19Ethereum Signed Message:\n32', msg).slice(2);
                privateHash = (0, solidity_helpers_1.soliditySha3)(privateKey).slice(2);
                sig = (0, ethereumjs_util_1.ecsign)(Buffer.from(hash, 'hex'), Buffer.from(privateHash, 'hex'));
                return [2 /*return*/, bytesToHexAddrLC(Buffer.concat([sig.r, sig.s, (0, ethereumjs_util_1.toBuffer)(sig.v)]))];
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: throw new Error("Provider error: Subscription with ID ".concat(subscriptionId, " does not exist."));
                }
            });
        });
    };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        deployTx.setCode((0, crypto_utils_1.bufferToProtobufBytes)(data));
                    ...
                    case 1:
                        ret = _a.sent();
                        response = loom_pb_1.DeployResponse.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(ret));
                        responseData = loom_pb_1.DeployResponseData.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(response.getOutput_asU8()));
    ...
    LoomProvider.prototype._callAsync = function (payload) {
        ...
        callTx.setInput((0, crypto_utils_1.bufferToProtobufBytes)(data));
        callTx.setValue((0, big_uint_1.marshalBigUIntPB)(value));
    ...
    LoomProvider.prototype._createBlockInfo = function (blockInfo, isFull) {
        ...
        var transactions = blockInfo.getTransactionsList_asU8().map(function (transaction) {
            if (isFull) {
                return _this._createTransactionResult(evm_pb_1.EvmTxObject.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(transaction)));
            }
            else {
    ...
    LoomProvider.prototype._createTransactionResult = function (txObject) {
        ...
        var value = "".concat(txObject.getValue());
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = Buffer.from(txHash.slice(2), 'hex');
                        return [4 /*yield*/, this._client.getEvmTxByHashAsync((0, crypto_utils_1.bufferToProtobufBytes)(data))];
                    case 1:
                        transaction = _a.sent();
                        if (!transaction) {
    ...
    LoomProvider.prototype._createLogResult = function (log) {
        return {
            ...
            transactionIndex: (0, crypto_utils_1.numberToHex)(log.getTransactionIndex()),
            transactionHash: bytesToHexAddrLC(log.getTransactionHash_asU8()),
            blockHash: bytesToHexAddrLC(log.getBlockHash_asU8()),
            blockNumber: (0, crypto_utils_1.numberToHex)(log.getBlockNumber()),
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logList = evm_pb_1.EthFilterLogList.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(logsListAsyncResult));
