...
var debugLog = (0, debug_1.default)('contract');
/**
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        debugLog("call '".concat(method, " on ").concat(this.address.toString(), " from ").concat(this.caller.toString()));
                        return [4 /*yield*/, this._client.commitTxAsync(tx)];
                    case 1:
                        result = _a.sent();
                        if (result && output) {
                            resp = loom_pb_1.Response.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(result));
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        debugLog("static call '".concat(method, " on ").concat(this.address.toString(), " from ").concat(this.caller.toString()));
                        return [4 /*yield*/, this._client.queryAsync(this.address, query.serializeBinary(), loom_pb_1.VMType.PLUGIN, this.caller)];
                    case 1:
                        result = _a.sent();
                        if (result && output) {
                            msgClass = output.constructor;
                            google_protobuf_1.Message.copyInto(msgClass.deserializeBinary((0, crypto_utils_1.bufferToProtobufBytes)(result)), output);
                        }
                        return [2 /*return*/, output];
                }
            });
